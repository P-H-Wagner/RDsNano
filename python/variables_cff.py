...
genVariables = cms.PSet(
        ...
        mu_gen_px     = Var("userFloat('mu_gen_px')",float),
        mu_gen_py     = Var("userFloat('mu_gen_py')",float),
        mu_gen_pz     = Var("userFloat('mu_gen_pz')",float),
        mu_gen_pt     = Var("userFloat('mu_gen_pt')",float),
        mu_gen_eta    = Var("userFloat('mu_gen_eta')",float),
        mu_gen_phi    = Var("userFloat('mu_gen_phi')",float),
        mu_gen_mass   = Var("userFloat('mu_gen_mass')",float),
        mu_gen_charge = Var("userFloat('mu_gen_charge')",float),
        mu_gen_pdgid  = Var("userInt('mu_gen_pdgid')", int),

        k1_gen_px     = Var("userFloat('k1_gen_px')",float),
        k1_gen_py     = Var("userFloat('k1_gen_py')",float),
        k1_gen_pz     = Var("userFloat('k1_gen_pz')",float),
        k1_gen_pt     = Var("userFloat('k1_gen_pt')",float),
        k1_gen_eta    = Var("userFloat('k1_gen_eta')",float),
        k1_gen_phi    = Var("userFloat('k1_gen_phi')",float),
        k1_gen_mass   = Var("userFloat('k1_gen_mass')",float),
        k1_gen_charge = Var("userFloat('k1_gen_charge')",float),
        k1_gen_pdgid  = Var("userInt('k1_gen_pdgid')",int),

        k2_gen_px     = Var("userFloat('k2_gen_px')",float),
        k2_gen_py     = Var("userFloat('k2_gen_py')",float),
        k2_gen_pz     = Var("userFloat('k2_gen_pz')",float),
        k2_gen_pt     = Var("userFloat('k2_gen_pt')",float),
        k2_gen_eta    = Var("userFloat('k2_gen_eta')",float),
        k2_gen_phi    = Var("userFloat('k2_gen_phi')",float),
        k2_gen_mass   = Var("userFloat('k2_gen_mass')",float),
        k2_gen_charge = Var("userFloat('k2_gen_charge')",float),
        k2_gen_pdgid  = Var("userInt('k2_gen_pdgid')",int),

        pi_gen_px     = Var("userFloat('pi_gen_px')",float),
        pi_gen_py     = Var("userFloat('pi_gen_py')",float),
        pi_gen_pz     = Var("userFloat('pi_gen_pz')",float),
        pi_gen_pt     = Var("userFloat('pi_gen_pt')",float),
        pi_gen_eta    = Var("userFloat('pi_gen_eta')",float),
        pi_gen_phi    = Var("userFloat('pi_gen_phi')",float),
        pi_gen_mass   = Var("userFloat('pi_gen_mass')",float),
        pi_gen_charge = Var("userFloat('pi_gen_charge')",float),
        pi_gen_pdgid  = Var("userInt('pi_gen_pdgid')",int),

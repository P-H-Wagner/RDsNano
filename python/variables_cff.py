...
genVariables = cms.PSet(
        ...
        mu_rel_iso_gen    = Var("userFloat('mu_rel_iso_gen')",float),
        e_gamma_gen       = Var("userFloat('e_gamma_gen')",float),
...
helicityVariables = cms.PSet(
        ...
        angPhiDs_reco1      = Var("userFloat('angPhiDsReco1')",float),
        angPhiDs_reco2      = Var("userFloat('angPhiDsReco2')",float),
        ...
        angPiDs_reco1       = Var("userFloat('angPiDsReco1')",float),
        angPiDs_reco2       = Var("userFloat('angPiDsReco2')",float),
        ...
        cosPhiDs_reco1      = Var("userFloat('cosPhiDsReco1')",float),
        cosPhiDs_reco2      = Var("userFloat('cosPhiDsReco2')",float),
        ...
        cosPiDs_reco1       = Var("userFloat('cosPiDsReco1')",float),
        cosPiDs_reco2       = Var("userFloat('cosPiDsReco2')",float),
        ...
        angMuW_reco1        = Var("userFloat('angMuWReco1')",float),
        angMuW_reco2        = Var("userFloat('angMuWReco1')",float),
        ...
        cosMuW_reco1        = Var("userFloat('cosMuWReco1')",float),
        cosMuW_reco2        = Var("userFloat('cosMuWReco2')",float),
        ...
        cosPlaneBs_reco1    = Var("userFloat('cosPlaneBsReco1')",float),
        cosPlaneBs_reco2    = Var("userFloat('cosPlaneBsReco2')",float),
        ...
        cosPlaneDs_reco1    = Var("userFloat('cosPlaneDsReco1')",float),
        cosPlaneDs_reco2    = Var("userFloat('cosPlaneDsReco2')",float),
